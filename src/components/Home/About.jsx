            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">Aman Singh </span>
                 and I'm from <span className="yellow"> Lucknow, UttarPradesh, India.</span>
                <br />
                <br />
                I am currently a Final year undergraduate in the Computer Science Engineering at Institute of Engineering & Technology, Lucknow.
                <br />
                <br />
                  As a
              ...
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  <li className="social-icons">
                    <a
                      href="https://github.com/aman-s-20"
                      target="_blank"
                      rel="noreferrer"
